...
export const LoaderOne = ({ className, color }: { color?: string; className?: string }) => {
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      <motion.div
        ...
        className={cn("h-4 w-4 rounded-full border border-neutral-300 bg-gradient-to-b from-neutral-400 to-neutral-300", color)}
      />
      <motion.div
        initial={{
          y: 0,
